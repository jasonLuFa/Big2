...
func (s *Straight) IsBigger(cardPattern domain.CardPattern) (bool, error) {
	targetSortedStraightCards, isStraightCard := ValidateStraightCard(cardPattern)
	if !isStraightCard {
	...
	return s.GetCards()[4].IsBigger(targetSortedStraightCards[4]), nil
}

func ValidateStraightCard(cardPattern domain.CardPattern) ([]*domain.Card, bool) {
